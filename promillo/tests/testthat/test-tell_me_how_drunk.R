...
test_that("basic implementation is correct", {
  expect_equivalent(
    tell_me_alcohol_amount(
      drinks = c("pils" = 1)
    ),
    13.2, tolerance = 0.01)
  
  expect_equivalent(
    tell_me_amount_body_water(
    age = 30,
    sex = "male",
    height = 176,
    weight = 78
    ),
    44.717, tolerance = 0.01
  )
  ...
  expect_equivalent(
    tell_me_how_drunk(
      ...
      height = 176,
      weight = 78,
      drinking_time = as.POSIXct(c("2016-10-03 17:15:00", "2016-10-03 17:15:00")),
      drinks = c("pils" = 1)
    ),
    0.2238, tolerance = 0.01)
  
  expect_equivalent(
    tell_me_current_blood_alcohol_level(
      blood_alcohol_level = 1.15,
      drinking_time = as.POSIXct(c("2016-10-03 12:00:00", "2016-10-03 18:00:00"))
      ),
    0.4, tolerance = 0.01)
